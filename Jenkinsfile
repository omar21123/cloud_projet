pipeline {
    ...
    environment {
        ...
        ZAP_TARGET        = "https://project-cloud.online"
...
'''
        ...
        stage('Security Scan — OWASP ZAP') {
            steps {
                script {
                    env.LAST_STAGE = 'Security Scan — OWASP ZAP'
...
🛡️ *Scan sécurité exécuté*
Consulte les logs Jenkins pour voir les résultats :
